...
var Table = function (_a) {
    ...
    for (var col in columns) {
        if (columns[col]) {
            ...
            cells.push(react_1.default.createElement(TableRow, { onClick: handleColumnClick, affected: false, inTheQuery: false, title: column.comment, "data-tablename": tablename, "data-columnname": column.columnname },
                inTheQuery && react_1.default.createElement(grommet_icons_1.StatusGood, { style: { height: '15px' }, color: "#26c281" }),
                react_1.default.createElement(TableCell, null, column.columnname),
                react_1.default.createElement(TableCell, null, column.datatype)));
        }
    }
